...
<div class="container">
    <div class="card">
        <div class="card-header">
            ...
            <div class="row">
                <form class="row" action="/students/classInfo" method="post">
                    Filter:
                    <div class="col-6">
                        <select name="groupId" id="" class="form-select" >
            ...
            <table class="table table-hover">
                ...
                <c:forEach items="${students}" var="student">
                    <tr>
                        ...
                        <td>
                            <a href="/students/delete?id=${student.id}" class="btn btn-danger">Delete</a>
                            <a href="/students/update?id=${student.id}" class="btn btn-primary">Update</a>
                        </td>
                    </tr>
